...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'admin_settings.provider_none': 'None',
    'admin_settings.from_address': 'From address',
    'admin_settings.from_name': 'From name',
    ...
    'admin_settings.test_email': 'Test Email',
    'admin_settings.test_email_address': 'Recipient address',
    'admin_settings.test_email_sent': 'Test email sent!',
    'admin_settings.test_email_failed': 'Failed to send test email',
  ...
  zh: {
    ...
    'admin_settings.provider_none': '无',
    'admin_settings.from_address': '发件地址',
    'admin_settings.from_name': '发件人名称',
    ...
    'admin_settings.test_email': '测试邮件',
    'admin_settings.test_email_address': '收件地址',
    'admin_settings.test_email_sent': '测试邮件已发送！',
    'admin_settings.test_email_failed': '测试邮件发送失败',
