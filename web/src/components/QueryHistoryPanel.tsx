        ...
        <div className="flex-1 overflow-auto">
          {items.map((item) => (
            <button
              ...
              className="w-full text-left px-4 py-3 border-b border-zinc-100 hover:bg-zinc-50 dark:border-zinc-800/50 dark:hover:bg-zinc-800/30 transition-colors group"
            >
              <div className="flex items-center gap-1.5 mb-1">
                ...
                {item.duration_ms !== null && (
                  <>
                    ...
                    <span className="text-xs text-zinc-400 dark:text-zinc-600">{item.duration_ms}ms</span>
                  </>
                )}
              ...
              <pre className="text-xs text-zinc-600 font-mono truncate group-hover:text-zinc-900 dark:text-zinc-400 dark:group-hover:text-zinc-200 transition-colors">
                {item.sql}
              </pre>
            </button>
          ))}
